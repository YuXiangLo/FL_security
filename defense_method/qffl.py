...
from defense_method.aggregate import aggregate_qffl

class QfflServer(FedAvg):
    ...
    def aggregate_fit(
        ...
        aggregated_ndarrays = aggregate_qffl(weights_results, self.num_malicious, self.to_keep)
